...
*SORT gt_table BY id. " kucukten buyuge
SORT gt_table BY id DESCENDING. " buyukten kucuge
...
ULINE.
SORT gt_table BY name job  ASCENDING. " kucukten buyuge
